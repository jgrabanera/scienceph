        ...
        <div class="article-section">
            <h2>Popular Article</h1>
                ...
                <div class="sections">
                    ...
                    <?php $__currentLoopData = $topNewArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topNewArticle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="article-1">
                            <h3><?php echo e($topNewArticle->title); ?></h3>
                            <p class="article-date-posted">Date posted: <?php echo e(date('M-d-Y h:i A', strtotime($topNewArticle->created))); ?></p>
                            ...
                            <div class="text-container">
                                <p class="full-text">
                                    <?php echo $topNewArticle->introtext; ?>
...
<?php /**PATH C:\Users\etien\OneDrive\Desktop\DOST PROJ\scienceph\resources\views/welcome.blade.php ENDPATH**/ ?>